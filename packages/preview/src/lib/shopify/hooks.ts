...
import { useShopifyFetcher } from './fetcher';
...
export type ProductsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', edges: Array<{ __typename?: 'ProductEdge', cursor: string, node: { __typename?: 'Product', id: string, title: string, handle: string, images: { __typename?: 'ImageConnection', edges: Array<{ __typename?: 'ImageEdge', node: { __typename?: 'Image', id?: string | null, url: any, altText?: string | null, width?: number | null, height?: number | null } }> } } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean } } };


export const ProductsDocument = `
    query products($first: Int!, $last: Int, $before: String, $after: String, $sortKey: ProductSortKeys = BEST_SELLING, $reverse: Boolean, $query: String) {
  products(
    first: $first
    last: $last
    before: $before
